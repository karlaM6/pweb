...
import co.edu.javeriana.proyectoWeb.RegataOnline.services.JwtService;
...
// java.util.Collections no longer required
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    UserDetails userDetails = jugadorServicio.userDetailsService()
        .loadUserByUsername(username);
                ...
                if (SecurityContextHolder.getContext().getAuthentication() == null) {
                    ...
                    // Use the authorities provided by UserDetails so role checks (e.g. @Secured)
                    // work correctly.
